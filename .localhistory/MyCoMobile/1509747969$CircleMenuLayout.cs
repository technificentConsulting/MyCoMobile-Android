...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : RelativeLayout
    {
      ...
      //);
        ...
        public void CView_Click(object sender, EventArgs m)
        {
            // this.mOnMenuItemClickListener = mOnMenuItemClickListener;
            Console.Write("Testing menu item click position is ");
        }


        public void setOnMenuItemClickListener(OnItemClickListener mOnMenuItemClickListener)
        {
            this.mOnMenuItemClickListener = mOnMenuItemClickListener;
        }
