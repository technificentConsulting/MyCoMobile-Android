...
namespace MyCoMobile
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            FrameLayout radialLayout = FindViewById<FrameLayout>(Resource.Id.radialLayout);
            menuRenderer = new RadialMenuRenderer(radialLayout, true, 30f, 60f);
            ...
            radialLayout.AddView(menuRenderer.RenderView());
