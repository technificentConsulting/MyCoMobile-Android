...
namespace MyCoMobile
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            mCircleMenuLayout.MenuItem_Click += itemClick;

            //listener.itemClick(mCircleMenuLayout, 0);
            //listener.itemCenterClick(mCircleMenuLayout);

        }

        public void MenuItem_Click(object sender, MenuItemOnMenuItemClickEventArgs m)
        {
