...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : ViewGroup
    {
        ...
        Context mContext;
        public CircleMenuLayout(Context context, IAttributeSet attr) :	 base(context)
			{
                init(context, attr);
            setPadding(0, 0, 0, 0);
        ...
        public CircleMenuLayout(Context context, int radius, List<TextView> elements) : base(context)
        {
            init(context);
            this.radius = radius;
