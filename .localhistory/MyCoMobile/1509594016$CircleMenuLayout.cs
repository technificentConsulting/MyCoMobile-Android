...
{
    public class CircleMenuEventArgs : MenuItemOnMenuItemClickEventArgs
    {
        public CircleMenuEventArgs(bool handled, IMenuItem item) : base(handled, item)
        {
    ...
    {
        private int mRadius;
        private static float RADIO_DEFAULT_CHILD_DIMENSION = 1 / 3f;
      ...
      //);
        ...
        public event EventHandler<CircleMenuEventArgs> MenuItemClicked;
        protected virtual void OnMenuItemClick(int pos)
        {
            if (MenuItemClicked != null)
            {
                //   MenuItemClicked(this, new CircleMenuEventArgs(){true, new Menu().});
                Console.WriteLine("The menu item position is => ", pos);
            }
        }

        public void OnMenuItemClick(object sender, CircleMenuEventArgs m)
        {
            // this.mOnMenuItemClickListener = mOnMenuItemClickListener;
            Console.Write("Testing menu item click position is " + m.position);
        }


        //public Action<View, int> MenuItem_Click { get; internal set; }
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            View cView = FindViewWithTag("tag.equals("+   FindViewById(Resource.Id.circle_menu_item_image);
            if (cView != null)
            {
        ...
        private void CView_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    mOnMenuItemClickListener.itemCenterClick((View)sender);
            //}
        }
            ...
            for (int i = 0; i < mMenuItemCount; i++)
            {
                ...
                if (iv != null)
                {
                    ...
                    iv.Click += (object sender, EventArgs e) =>
                    {
                        ...
                        if (mOnMenuItemClickListener != null)
                        {
                           // MenuItemClicked += MenuItemClicked(this, new EventArgs() { position = i });
                        }
