...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : RelativeLayout
    {
        ...
        private AutoFlingEvent mFlingRunnable;
        ...
        protected virtual void OnMenuItemClick(int pos)
        {
            ...
            {
                MenuItemClicked(this, new CircleMenuEventArgs(){ position = pos });
            }
        }
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            if (cView != null)
            {
                ...
                Console.WriteLine("cView clicked");
                ...
                if (iv != null)
                {
                    ...
                    iv.Click += (object sender, EventArgs e) =>
                    {
                        Console.WriteLine("ImageView clicked");
                         //if (mOnMenuItemClickListener != null)
                         //           {
                         ///              mOnMenuItemClickListener ((View)sender, int.Parse(e.ToString()));
                         //           }
    ...
    public class AutoFlingEvent
    {
        ...
        public delegate void AutoFlingDelegate(float velocity);
        public event AutoFlingDelegate AutoFlingHandler;


        float angelPerSecond;

        public void FlingObject()
        {
            if(AutoFlingHandler != null)
            {
                AutoFlingHandler(angelPerSecond);
            }
        }
        ...
        //public Action ActionAutoFlingRunnable(float velocity)
        //{
