...
{
    [Activity(NoHistory = true, MainLauncher = true, ScreenOrientation = Android.Content.PM.ScreenOrientation.Landscape, Theme = "@style/AppTheme", Label = "Launcher")]
    ...
    public class LauncherActivity : Activity, MediaPlayer.IOnPreparedListener, ISurfaceHolderCallback
    {
        ...
        void OpeningVideo()
        {
            ...
            VideoView videoView = FindViewById<VideoView>(Resource.Id.introVideo);
