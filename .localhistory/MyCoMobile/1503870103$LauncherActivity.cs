...
namespace MyCoMobile
{
    ...
    public class LauncherActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            setDefaults(FindViewById<LinearLayout>(Resource.Id.launchCenterview).FindViewById<RelativeLayout>(Resource.Id.launchMainLayout));
            openingAnimation();
        ...
        public override void OnWindowFocusChanged(bool hasFocus)
    {
        ...
        setDefaults(FindViewById<RelativeLayout>(Resource.Id.mainLayout));
        openingAnimation();
    }
