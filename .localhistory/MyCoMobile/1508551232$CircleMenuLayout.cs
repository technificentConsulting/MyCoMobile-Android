...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : ViewGroup
    {
        ...
        private void addMenuItems()
        {
            ...
            MyCoMobile.CircleMenuLayout v = FindViewById<MyCoMobile.CircleMenuLayout>(Resource.Id.menulayout);
            ...
            for (int i = 0; i < mMenuItemCount; i++)
            {
                ...
                if (iv != null)
                {
                    v.AddView(new ImageView(Context) { Background = Resources.GetDrawable(Resource.Drawable.ani0_logo) });
  ...
  //public class AutoFlingRunnable
  //      { 
  //          public Action Runnable(float velocity)
  //          {
  //              float angelPerSecond;
