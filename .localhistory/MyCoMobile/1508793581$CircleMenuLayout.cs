...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : RelativeLayout
    {
        ...
        public delegate void MenuItemClickEventHandler(object sender, EventArgs args);
        public event MenuItemClickEventHandler MenuItem_Clicked;
        protected virtual void mOnMenuItemClick()
        {
            if (MenuItem_Clicked != null)
            {
                MenuItem_Clicked(this, EventArgs.Empty);
            }
        }

        public void OnMenuItemClick(object sender, EventArgs m)
        {
            // this.mOnMenuItemClickListener = mOnMenuItemClickListener;
            Console.WriteLine("Testing menu item click");
        }
