...
namespace MyCoMobile
{
    ...
    public class CircleMenuLayout : RelativeLayout
    {
      ...
      //);
        ...
        public event EventHandler<CircleMenuEventArgs> ItemClickedFinished;

 

        protected virtual void OnItemClickFinished(object sender, CircleMenuEventArgs e)
        {
            if (ItemClickedFinished != null)
            {
                ItemClickedFinished(this, e);
            ...
            for (int i = 0; i < mMenuItemCount; i++)
            {
                ...
                if (iv != null)
                {
                    ...
                    iv.Click += (object sender, EventArgs e) =>
                    {
                        ...
                        OnItemClickFinished(this, new CircleMenuEventArgs() { position = i });
